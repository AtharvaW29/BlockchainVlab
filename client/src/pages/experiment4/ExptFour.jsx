...
import ethereum4 from '../../assets/images/Expt4.jpg'
...
The mining of a block experiment involves the computational process of solving complex mathematical puzzles to validate transactions and add a new block to the blockchain network.</p>
        <div className="mt-6">
            <img src={ethereum4} alt="Blockchain Image" className="w-full rounded-lg shadow-lg" />
        </div>
        <div className="mt-8">
            <a href="/Procedure4" className="py-2 px-6 bg-yellow-500 hover:bg-yellow-600 text-white font-bold rounded-lg shadow-lg transition duration-300">Start Experiment</a>
        </div>
    </div>
