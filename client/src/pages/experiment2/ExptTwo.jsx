...
const ExptTwo = () => {
  return (
    ...
    <div className="max-w-lg p-6 rounded-lg bg-blue-900 bg-opacity-10 backdrop-blur-lg text-center text-blue-900">
        ...
        <div className="mt-8">
            <a href="/Procedure2" className="py-2 px-6 bg-yellow-500 hover:bg-yellow-600 text-white font-bold rounded-lg shadow-lg transition duration-300">Start Experiment</a>
        </div>
    </div>
